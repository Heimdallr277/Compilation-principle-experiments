...
public class ClassInfo {
     ...
     * Static method names.
     */
    public final Set<String> lambdaMethods;
    ...
    public ClassInfo(String name, Optional<String> parent, Set<String> memberVariables,
                     Set<String> memberMethods, Set<String> staticMethods, Set<String> lambdaMethods, boolean isMainClass) {
        this.name = name;
        this.parent = parent;
