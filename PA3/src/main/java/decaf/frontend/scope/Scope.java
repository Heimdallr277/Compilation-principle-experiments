...
public abstract class Scope implements Iterable<Symbol> {
    ...
    public boolean isLambdaScope() { return false; }

    public boolean isFormalOrLocalScope() {
        return isFormalScope() || isLocalScope() || isLambdaScope();
    }

    public boolean isLambdaOrLocalScope() {
        return isLocalScope() || isLambdaScope();
    }

    public boolean isReallyFormalOrLocalScope() {
